...
Unzip it, and it will spew out a single folder, which is probably named something like `InjuryNotifier-master`.
...
`C:\Program Files (x86)\Steam\steamapps\common\RimWorld\Mods\InjuryNotifier-master\Assemblies`
...
`C:\Program Files (x86)\Steam\steamapps\common\RimWorld\Mods\InjuryNotifier-master`
